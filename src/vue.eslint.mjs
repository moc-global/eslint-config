 ...
 * @returns {import('eslint').Linter.FlatConfig[]} The composed Vue flat-config array for JavaScript SFCs (base Vue rules + overrides).
 * @example
 ...
 * Combine with createNodeConfig() for full coverage.
 * @returns {import('eslint').Linter.FlatConfig[]} The composed Vue flat-config array for TypeScript SFCs (base Vue rules + type-aware Vue rules + overrides).
 * @example
 * import { createNodeConfig } from './.eslint/node.eslint.mjs';
